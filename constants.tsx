...
export const SERVICES: ServiceDetail[] = [
  // System Integration
  {
    ...
    benefits: ['Scalability', 'Reliability', 'Performance Optimization','Capacity Planning','Infrastructure Resilience'],
  ...
  },
  {
    ...
    benefits: ['Zero-Trust Security', 'Global Connectivity', 'Uptime','Threat Prevention'],
  ...
  },
  {
    ...
    benefits: ['Cost Efficiency', 'Agility', 'Disaster Recovery','Hybrid Infrastructure','Resource Optimization'],
  ...
  },
  {
    ...
    description: 'Ensuring your systems meet global standards like ISO 27001.',
    benefits: ['Risk Mitigation', 'Legal Safety', 'Customer Trust','Vulnerability Management'],
